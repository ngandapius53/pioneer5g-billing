(() => {
  ...
  const defaultState = () => {
    ...
    const vouchers = [
      ...
      buildVoucher("PNR-5A6P-JD8R", PLAN_LIBRARY[2], "Sold", "c-002", addDays(-1), "u-cashier", "BATCH-20260619-WKL"),
      buildVoucher("PNR-R8Q2-LM7C", PLAN_LIBRARY[3], "Used", "c-003", addDays(-12), "u-manager", "BATCH-20260608-MTH"),
      buildVoucher("PNR-XL33-8FNT", PLAN_LIBRARY[3], "Expired", "c-003", addDays(-48), "u-manager", "BATCH-20260503-MTH"),
      ...
      ...seedAvailable("BATCH-20260619-WKL", PLAN_LIBRARY[2], 9, "W"),
      ...seedAvailable("BATCH-20260608-MTH", PLAN_LIBRARY[3], 5, "M"),
    ...
    const sales = [
      ...
      makeSale("s-003", invoiceFor(addDays(-1), 2, "INV"), invoiceFor(addDays(-1), 2, "RCP"), "c-002", "PNR-5A6P-JD8R", PLAN_LIBRARY[2], "Mobile Money", "u-cashier", addDays(-1)),
      makeSale("s-004", invoiceFor(addDays(-12), 1, "INV"), invoiceFor(addDays(-12), 1, "RCP"), "c-003", "PNR-R8Q2-LM7C", PLAN_LIBRARY[3], "Card", "u-manager", addDays(-12)),
      makeSale("s-005", invoiceFor(addDays(-48), 1, "INV"), invoiceFor(addDays(-48), 1, "RCP"), "c-003", "PNR-XL33-8FNT", PLAN_LIBRARY[3], "Mobile Money", "u-manager", addDays(-48)),
